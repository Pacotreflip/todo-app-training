...
window.Vuex = __webpack_require__(57);
...
var update = __webpack_require__(11)("b88ef4d4", content, false, {});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        toggleDone: function toggleDone() {
            this.$emit('toggleDone', { id: this.id, done: this.done });
            this.done = !this.done;
        }
    }
});
